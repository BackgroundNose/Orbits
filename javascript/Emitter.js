...
Emitter.prototype.emit = function(toEmit)
{
	...
	while (toEmit > 0)
	{
		...
		var anim = this.particleList[emitIDX].sprite.spriteSheet._animations;
		this.particleList[emitIDX].sprite.gotoAndPlay(anim[Math.floor(Math.random()*anim.length)])			// goto random animation
		...
		if (this.particlePrototype.randomFrame)	{
